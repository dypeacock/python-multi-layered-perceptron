...
class MLP:
    ...
    def sigmoid(self, x):
        """
        This is the sigmoid activation function, which squashes the input values between 0 and 1,
        used for introducing non-linearity into the network
        """
        return 1 / (1 + np.exp(-x))

    def sigmoid_derivative(self, x):
        """
        This method computes the derivative of the sigmoid function,
        which is used during backpropagation to compute gradients.
        """
        return x * (1 - x)
